...
We are trying to predict the '1' values thus we optimize for Sensitivity, predicting positive outcomes, over Accuracy. sensitivity

prSummary = c('AUC', 'Precision', 'Recall' )
...
AUC went down significantly to 87.43%
