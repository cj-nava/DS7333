...
We then estimate the parameters of the stationarized data with `aic5.wge`.
...
Both the AIC and BIC suggest an ARIMA (1,2,1) model where p=1, d=2, and q=1. When the parameters are estimated using 
