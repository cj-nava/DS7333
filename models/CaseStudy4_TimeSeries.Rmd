...
A comparison of the ACF plots for the log-transformed data shows the first half (Figure 7) is identical to the second half (Figure 8), which suggests constant autocovariance over time.
```{r fig.height=4,fig.width=11}
# to compare the ACF structure of the first half of the data to the second half.
par(mfrow = c(1,2))
